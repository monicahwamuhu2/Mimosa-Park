            ...
            <button
              ...
              className={`inline-flex items-center justify-center rounded-full p-2.5 transition-all duration-300 ${
                transparent
                  ...
                  : 'text-gray-700 bg-gray-100 hover:bg-mimosa-50 hover:text-mimosa-600'
              }`}
            >
        ...
        {mobileMenuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-y-0 right-0 z-[70] w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm shadow-2xl lg:hidden"
            >
              {/* Menu Header */}
                      ...
                      >
                        ...
                        >
                          <div className="flex items-center">
                            <span className={`mr-3 h-1.5 w-1.5 rounded-full flex-shrink-0 ${
